...
const ExportToExcel = ({
  ...
  const getBookCountByUserType = (userType) => {
    const r = bookUserType.bookUserTypeC.find(
      (obj) => obj.user_type === userType
    );
    if (r) {
  ...
  const getBookCountByYearLevel = (yearLevel) => {
    const r = bookYearLevel.bookYearLevelC.find(
      (obj) => obj.year_level === yearLevel
    );
    if (r) {
  ...
  const getGameCountByUserType = (userType) => {
    const r = gameUserType.gameUserTypeC.find(
      (obj) => obj.user_type === userType
    );
    if (r) {
      return r._count.user_type;
  ...
  const getGameCountByYearLevel = (yearLevel) => {
    const r = gameYearLevel.gameYearLevelC.find(
      (obj) => obj.year_level === yearLevel
    );
  ...
  const bookRequestsPerUserType = usagePerUserType
    ? [
        ...
        [
          getBookCountByUserType("Student"),
          getBookCountByUserType("Faculty"),
          getBookCountByUserType("Staff"),
          bookUserType.bookReqCount,
        ],
        [""],
      ]
    : [];
  ...
  const gameRequestsPerUserType = usagePerUserType
    ? [
        ...
        ["Student", "Faculty", "Staff", "Total"],
        [
          getGameCountByUserType("Student"),
          getGameCountByUserType("Faculty"),
          getGameCountByUserType("Staff"),
          gameUserType.gameReqCount,
        ],
        [""],
      ]
    : [];
  ...
  const bookRequestsPerYearLevel = usagePerYearLevel
    ? [
        ...
        [
          getBookCountByYearLevel("1st Year"),
          getBookCountByYearLevel("2nd Year"),
          getBookCountByYearLevel("3rd Year"),
          getBookCountByYearLevel("4th Year"),
          bookYearLevel.studentBookReqs,
        ],
        [""],
      ]
    : [];
  ...
  const gameRequestsPerYearLevel = usagePerYearLevel
    ? [
        ...
        ["1st Year", "2nd Year", "3rd year", "4th Year", "Total"],
        [
          getGameCountByYearLevel("1st Year"),
          getGameCountByYearLevel("2nd Year"),
          getGameCountByYearLevel("3rd Year"),
          getGameCountByYearLevel("4th Year"),
          gameYearLevel.studentGameReqs,
        ],
        [""],
      ]
    : [];
  ...
  const bookRequestsPerDept = usagePerDepartment
    ? [
        ...
        [
          getBookCountByDept("Information Technology"),
          getBookCountByDept("Computer Science"),
          getBookCountByDept("Information Systems"),
          bookDept.studentBookReqs,
        ],
      ]
    : [];
  ...
  const gameRequestsPerDept = usagePerDepartment
    ? [
        ...
        [
          getGameCountByDept("Information Technology"),
          getGameCountByDept("Computer Science"),
          getGameCountByDept("Information Systems"),
          gameDept.studentGameReqs,
        ],
      ]
    : [];
  ...
  const bookRows = totalCount
    ? bookUsage.bookRCounts.map((r) => {
  ...
  const gameRows = totalCount
    ? gameUsage.gameRCounts.map((r) => {
        const boardgame = gameUsage.gameR.find(
          (e) => e.boardgame_id === r.boardgame_id
        ).boardgame;
