  ...
  const MyDocument = () => (
    ...
    <Document>
      <Page size="LETTER" style={stylesPDF.page}>
        ...
        <View style={stylesPDF.admin_info}> 
          <Text>Generated by: Sample Name</Text>
        ...
        <View style={stylesPDF.user_demographics}>
          <Text style={{paddingLeft: 60}}>User Demographics:</Text>
          <View style={stylesPDF.table}>
          </View>
        </View>
        <View style={stylesPDF.usage_statistics}>
          <Text style={{paddingLeft: 60}}>Usage Statistics:</Text>
